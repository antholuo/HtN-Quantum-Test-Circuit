...
from orquestra.quantum.circuits import CNOT, Circuit, X, Z, XX, ZZ, MatrixFactoryGate
        ...
        for operation in circuit.operations:
            if operation.gate is self.U:
                for P in self.bread_gates:
                    ...
                    def create_matrix_factory(_):
                        return Pprime_matrix
                    P.matrix_factory = create_matrix_factory
